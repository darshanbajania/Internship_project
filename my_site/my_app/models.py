...
class Proposal(models.Model):
    ...
    svm_categories = models.CharField(
        default='no svm categories', max_length=200, blank=True)
    text = models.TextField(default='no text', max_length=10000)
    title = models.CharField(default='no title', max_length=500)
    mentor_assigned = models.CharField(
        default='no mentor assigned', max_length=100)
